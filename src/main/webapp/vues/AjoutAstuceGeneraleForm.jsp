...
<jsp:include page="/vues/header.jsp" >	
   <jsp:param name="pageHeader" value="Ajout astuce" />
   <jsp:param name="pageTitle" value="Formulaire d'ajout d'astuce générale!" />
...
<form method="post" action="/NekoAtsume/AjoutAstuceGenerale"  >
